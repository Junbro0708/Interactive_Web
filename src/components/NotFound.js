...
function NotFound() {
  ...
  const [isBeamAnim, setIsBeamAnim] = useState(false);
  ...
  const handleBeamAnimStart = () => {
    setIsBeamAnim(true);
  }

  const handleBeamAnimEnd = () => {
    setIsBeamAnim(false);
  }
    ...
    <div className='not-found-body'>
      <svg id="ufo-image" viewBox="0 0 2303 1630" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g id="gogo_UFO">
          ...
          >
            <path d="M1143.5 497L1509 1474H1143.5H778L1143.5 497Z" fill="#9670BA" />
          </CSSTransition>
          <path id="4-L"
          ...
          <g id="alien">
            <g id="alien-head">
              ...
              <circle id="Ellipse 26" cx="1178.38" cy="404.033" r="14.9294" transform="rotate(7.76141 1178.38 404.033)"
                fill="white" />
              <line id="Line 5" x1="1133.66" y1="382.034" x2="1192.83" y2="390.099" stroke="black" strokeWidth="11.6118"
                strokeLinecap="round" />
              <line id="Line 6" x1="1159.36" y1="402.278" x2="1157.35" y2="417.071" stroke="#09A82D" strokeWidth="11.6118"
                strokeLinecap="round" />
              <line id="Line 7" x1="1134.45" y1="431.529" x2="1164.03" y2="435.561" stroke="#5EDF7A" strokeWidth="16.5882"
                strokeLinecap="round" />
              <line id="Line 8" x1="1136.09" y1="431.753" x2="1160.75" y2="435.113" stroke="#09A82D" strokeWidth="3.31765"
                strokeLinecap="round" />
          ...
          <g id="alien_Leg-L">
            <path id="Vector 5" d="M1167.32 481.051C1162.81 481.266 1152.72 483.64 1148.44 491.418" stroke="#09A82D"
              strokeWidth="12" strokeLinecap="round" />
            <path id="Vector 9" d="M1142.36 487.071L1147.87 490.931" stroke="#09A82D" strokeWidth="12"
              strokeLinecap="round" />
          </g>
          <g id="alien_Leg-R">
            <path id="Vector 5_2" d="M1105.5 470C1100 471 1094 473.5 1090.43 479.918" stroke="#09A82D" strokeWidth="12"
              strokeLinecap="round" />
            <path id="Vector 9_2" d="M1084.36 475.571L1089.87 479.432" stroke="#09A82D" strokeWidth="12"
              strokeLinecap="round" />
          </g>
        </g>
      </svg>
